  ...
  return (
    <section className={styles.section}>
      ...
      <motion.p
        ...
        Компания «NNNNNNN» более 10 лет оказывает услуги вывоз и демонтажа черных и цветных металлов. Мы имеем собственный логистический центр и выезд происходит в течении пары часов.
      </motion.p>
