...
function TruckOrange() {
  return (
    <svg style={{margin: '0 0 20px'}} xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#c9686c" className="bi bi-truck-flatbed"
         viewBox="0 0 16 16">
      <path
